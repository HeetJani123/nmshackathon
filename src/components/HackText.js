  ...
  return (
    <>
      ...
      >
        ...
        <ul>
          <li><strong>Q: Will the Hackathon have different rounds?</strong><br/>
          A: No, the Hackathon will consist of a single round.</li><br/>

          <li><strong>Q: How do we submit the answers?</strong><br/>
          ...
          <li><strong>Q: What does the correction committee mainly look for in your answers (judging criteria)?</strong><br/>
          ...
          <li><strong>Q: Will the use of external libraries be allowed, and is it necessary?</strong><br/>
      ...
      >
        ...
        <p>
          <ul>
            ...
            <li><strong>Misconduct Penalties:</strong>Teams violating rules will face disqualification</li>
          </ul>
