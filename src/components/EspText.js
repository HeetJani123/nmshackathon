    ...
    <>
      ...
      >
        ...
        <p>
          ...
          <br />
          <strong>Schedule:</strong> Event starts at 10 AM with registration, followed by Round of 32 matches. Final match to be played at 12 PM.
        </p>
        ...
        <h2>11. FAQs</h2>
        <p>
          <strong>Which mode are we playing on and can I use any team?</strong> The tournament will be played through the kick off mode and not ultimate team. Yes, you can use any team including nations except for Soccer Aid FC.
          <br />
